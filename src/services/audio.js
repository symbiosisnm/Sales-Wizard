    ...
    try {
        ...
        if (SpeechRecognition) {
            return await new Promise((resolve, reject) => {
                ...
                recognition.onresult = e => resolve(e.results[0] && e.results[0][0] ? e.results[0][0].transcript : '');
        ...
        return await new Promise((resolve, reject) => {
            ...
            recorder.onstop = async () => {
                try {
                    ...
                    const method =
                        process.env.TRANSCRIPTION_METHOD || (process.env.GEMINI_API_KEY ? 'gemini' : process.env.LOCAL_TRANSCRIBE_URL ? 'local' : '');
